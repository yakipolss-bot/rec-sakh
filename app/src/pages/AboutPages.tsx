...
const content: Record<AboutTab, { title: string; body: string[] }> = {
  ...
  advertising: {
    ...
    body: [
      ...
      'По вопросам размещения рекламы обращайтесь по адресу: advertising@sakhcom.ru или по телефону: +7 (4242) 00-00-00.',
    ],
  },
  contacts: {
    ...
    body: [
      ...
      'Email: news@sakhcom.ru',
      'По техническим вопросам: support@sakhcom.ru',
  ...
  vacancies: {
    ...
    body: [
      ...
      'Резюме направляйте на hr@sakhcom.ru с пометкой «Вакансия: [название]».',
    ],
  },
  agreement: {
