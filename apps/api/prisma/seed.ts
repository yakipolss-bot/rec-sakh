...
async function main() {
  ...
  const categoryData = [
    ...
    { name: 'Фестивали', slug: 'festivali', type: 'events' as const, sortOrder: 5 },
    { name: 'Экскурсии', slug: 'ekskursii', type: 'events' as const, sortOrder: 6 },
    { name: 'Спорт', slug: 'sport', type: 'events' as const, sortOrder: 7 },
    { name: 'Мастер-классы', slug: 'master-klassy', type: 'events' as const, sortOrder: 8 },
    { name: 'Обучение', slug: 'obuchenie', type: 'events' as const, sortOrder: 9 },
    { name: 'Детям', slug: 'detyam', type: 'events' as const, sortOrder: 10 },
  ...
  const events = [
    ...
    },
    {
      ...
      categoryId: categoryMap['festivali']!,
      city: 'Южно-Сахалинск',
